...
<body>
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title">7Above Dashboard</h2>
			<div class="btn_view_site"><a href="../Login/Home.php">View Site</a></div>
		</hgroup>
	</header>
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="AdminHome.php">Website Admin</a><div class="breadcrumb_divider"></div><a class="current">Dashborad</a></article>
		</div>
	</section>
