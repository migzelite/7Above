...
<script type="text/javascript">
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="admin.php">7Above Website Admin</a></h1>	
			<h2 class="section_title">7Above Dashboard</h2><div class="btn_view_site"><a href="../Login/Home.php">View Site</a></div>
		</hgroup>
	</header>
	...
	<aside id="sidebar" class="column">
		...
		<ul class="toggle">
			...
			<li class="icn_jump_back"><a href="../Login/logout.php">Logout</a></li>
		</ul>
	</aside>
   ...
   <div align="justify">
      <table width="317" height="369" class="jqx-panel">
          ...
          <tr>
              <td>Permissions</td>
              <td><ul>
                <li><input name="permissions[]" type="checkbox" id="Login" class="checkbox" value=1 />Home</li>
                <li><input name="permissions[]" type="checkbox" id="Adminsite" class="checkbox" value=2 />Admin Site</li>
                <li><input name="permissions[]" type="checkbox" id="Reports" class="checkbox" value=3 />Reports</li>
                <li><input name="permissions[]" type="checkbox" id="ClientData" class="checkbox" value=4 />Client Data</li>
                </ul></td>
          </tr>
