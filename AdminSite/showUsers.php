...
<body>
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="AdminHome.php">7Above Admin</a></h1>	
			<h2 class="section_title">7Above Dashboard</h2>
			<div class="btn_view_site">
			<a href="../Login/Home.php">View Site</a>
			</div>
		</hgroup>
	</header>
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="admin.php">7Above Website Admin</a><div class="breadcrumb_divider"></div><a class="current" href="showUsers.php">View Users</a></article>
		</div>
	</section>
