               	...
               	//data adapter
                	var dataAdapter = new $.jqx.dataAdapter(source);//,{
                	  ...
                	  $("#jqxgrid").jqxGrid({ 
  	                    ...
  	                    autoshowfiltericon: true,
  	                    columns: [
  	                        { text: 'Source URL', datafield: 'source_url', width: 150, filtertype: 'text' },
  	                        { text: 'Count', datafield: 'count', width: 250, filtertype: 'number' }]
