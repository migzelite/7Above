    ...
    <script type="text/javascript">
          ...
          $(document).ready(function() {
               ...
               var theme = getDemoTheme();
                var url = "getDEmographicInfo.php";
               //prepare data
              var  source ={
                    datatype: "json",
                    type: "POST",
               	...
               	//data adapter
                	var dataAdapter = new $.jqx.dataAdapter(source);//,{
                	  ...
                	  $("#jqxgrid").jqxGrid({ 
  	                    ...
  	                    autoshowfiltericon: true,
  	                    columns: [
  	                        {text: 'Email', datafield: 'email',filtertype:'textbox', width: 100 },
  	                        { text: 'Date', datafield: 'subscribe_date', filtertype: 'date', width: 150, cellsformat: 'MM/dd/yyyy HH:mm' },
  	                        { text: 'source_ip', datafield: 'source_ip', width: 150, filtertype: 'textbox' },
  	                        { text: 'source_url', datafield: 'source_url', width: 250, filtertype: 'textbox' }]
