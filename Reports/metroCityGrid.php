    ...
    <script type="text/javascript">
          ...
          $(document).ready(function() {
               ...
               var theme = getDemoTheme();
                var url = "getMetroCodebyCity.php";
               //prepare data
              var  source ={
                    datatype: "json",
                    type: "POST",
               	...
               	//data adapter
                	var dataAdapter = new $.jqx.dataAdapter(source);//,{
                	  ...
                	  $("#jqxgrid").jqxGrid({ 
  	                    ...
  	                    autoshowfiltericon: true,
  	                    columns: [
  	                        { text: 'City', datafield:'email', filtertype:'text' width:250},      
  	                        { text: 'Metrocode', datafield: 'metrocode',filtertype:'text', width: 150 }]
                       ...
                       if (selection.from != null) {
						 ...
						 var dataDate= dataAdapterDate.records;
						  var localSourceDate={
	                              datatype: 'json',
	                              datafields:[
								 	{ text: 'City', datafield:'city', filtertype:'text' width:250},
  	                        		{ text: 'Metrocode', datafield: 'smetrocode', width: 150, filtertype: 'text' } ],
	                              localdata:dataDate,
	                              sortcolumn:'city',
	                              sortdirection:'desc'
