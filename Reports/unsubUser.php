...
<head>
<meta charset="utf-8">
<title>Insert SpamCop/Abuse Complaints/ Unsubscribe </title>
</head>
...
<form class="form" id="form" method="post" action="UnsubscribeUser.php" style="font-size: 13px; font-family: Verdana; width: 650px;">
<table>
<tr>
<td id="box-header">
Email Addresses:
